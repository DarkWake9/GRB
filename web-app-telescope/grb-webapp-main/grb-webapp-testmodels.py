...
if page_nav == "GRB Quickview":
    ...
    beta.metric("Spectral index", str(data.loc[data.index == select_event, "beta"].to_numpy()[0]) + "+/-" + str(data.loc[data.index == select_event, "beta_err"].to_numpy()[0]))
    ...
    try:
        ...
        flux.download_button(
            label="Download data in erg cm-2 s-1",
            data=csv,
...
""")
    ...
    "Willingale 2007 + Simple broken power law"
    "Willingale 2007 + Simple power law",
    "Willingale 2007 + Simple broken power law + Simple power law",
    "Simple power law + Simple broken power law",
    "Simple power law + Simple broken power law + Simple power law"
    ])
    ...
    with param.form("Select parameters"):
        ...
        if select_model == "Willingale 2007":
        ...
        elif select_model == "Willingale 2007 + Simple broken power law":

            model = Model.W07_SIMPLE_BPL()

            Fp = st.number_input(label="F_p",
            max_value = -2,
            min_value = -18,
            value=data.loc[data.index == select_event, 'F_p'].to_numpy()[0],
            )

            alphap = st.number_input(label="alpha_p",
            max_value = 7,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_p'].to_numpy()[0],
            ) 
            
            alpha1 = st.number_input(label="alpha_1",
            max_value = 7,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_1'].to_numpy()[0],
            )

            alpha2 = st.number_input(label="alpha_2",
            max_value = 7,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_2'].to_numpy()[0],
            ) 

            t0 = st.number_input(label="t0",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 't0'].to_numpy()[0],
            )

            t1 = st.number_input(label="t1",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 't1'].to_numpy()[0],
            )

            t2 = st.number_input(label="t2",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 't2'].to_numpy()[0],
            )

            t = st.number_input(label="t",
            max_value = 5,
            min_value = -1e-8,
            value=data.loc[data.index == select_event, 't'].to_numpy()[0],
            )


            p = [Fp,alphap,alpha1,alpha2,t0,t1,t2,t]
            

        elif select_model == "Willingale 2007 + Simple power law":

            model = Model.W07_POWER_LAW()
            ...
            Ta = st.number_input(label="T_a",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 'T_a'].to_numpy()[0],
            )

            Fa = st.number_input(label="F_a",
            max_value = -8,
            min_value = -18,
            value=data.loc[data.index == select_event, 'F_a'].to_numpy()[0],
            )

            alphaa = st.number_input(label="alpha_a",
            max_value = 7,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_a'].to_numpy()[0],
            ) 

            tt = st.number_input(label="tt",
            max_value = 10,
            min_value = -1e-8,
            value=data.loc[data.index == select_event, 'tt'].to_numpy()[0],
            )

            p = [Fp,alphap,Ta,Fa,alphaa,tt]
            

            

        elif select_model == "Willingale 2007 + Simple broken power law + Simple power law":

            model = Model.W07_SIMPLE_BPL_POWER_LAW()
            ...
            alpha3 = st.number_input(label="alpha_3",
            max_value = 7,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_3'].to_numpy()[0],
            )
            t0 = st.number_input(label="t0",
            max_value = 10,
            min_value = 0,
            ...
            t3 = st.number_input(label="t3",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 't3'].to_numpy()[0],
            )
            t = st.number_input(label="t",
            max_value = 5,
            min_value = -1e-8,
            ...
            p = [Fp,alphap,alpha1,alpha2,alpha3,t0,t1,t2,t3,t]

        elif select_model == "Simple power law + Simple broken power law":

            model = Model.POWER_LAW_SIMPLE_BPL()
            ...
            alphaa1 = st.number_input(label="alpha_a1",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_a1'].to_numpy()[0],
            )

            alphaa2 = st.number_input(label="alpha_a2",
            max_value = 10,
            min_value = 0,
            value=data.loc[data.index == select_event, 'alpha_a2'].to_numpy()[0],
            )
            ...
            p = [Fp,alphap,alphaa1,alphaa2,t0,t1]



        elif select_model == "Simple power law + Simple broken power law + Simple power law":

            model = Model.POWER_LAW_SIMPLE_BPL_POWER_LAW()    
            ...
            p = [Fp,alphap,alpha1,alpha2,alpha3,t0,t1,t2]   
